        ...
        <section className="py-24 bg-ocean-950 relative overflow-hidden text-center">
            <div className="max-w-5xl mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-ocean-900 via-ocean-950 to-black flex items-center justify-center">
                        <div className="absolute inset-0 opacity-10 bg-[tech-grid] bg-grid" />
