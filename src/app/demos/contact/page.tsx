...
export default function GilesContactPage() {
    ...
    return (
        <main className="bg-ocean-950 min-h-screen relative overflow-x-hidden flex flex-col">
            ...
            <div className="flex-grow mt-20 pt-16 pb-24 relative">
                {/* Background Effects */}
                    ...
                    <div className="space-y-12">
                        ...
                        >
                            ...
                            <p className="text-gray-400 max-w-lg font-mono text-sm leading-relaxed">
                                Ready to scale with AI? Send me a message below with your requirements and I'll be in touch to discuss a tailored solution.
                            </p>
                        </motion.div>
